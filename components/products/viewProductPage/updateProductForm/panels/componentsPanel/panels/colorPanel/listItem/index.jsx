...
export default function UpdateProductFormColorListItem({ data }) {
  const addProductColor = useUpdateProductFormStore(
    (state) => state.addProductColor
  );
  const removeProductColor = useUpdateProductFormStore(
    (state) => state.removeProductColor
  );
  const productColors = useUpdateProductFormStore(
