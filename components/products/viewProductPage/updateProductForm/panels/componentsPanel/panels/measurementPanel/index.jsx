...
import UpdateProductFormMeasurementListItem from "./listItem";
...
export default function UpdateProductFormComponentsPanelMeasurementPanel() {
              ...
              {filteredData.length > 0 &&
                filteredData
                  ...
                  .map((measurement, index) => {
                    return (
                      <UpdateProductFormMeasurementListItem
                        key={index}
                        data={measurement}
                      />
                    );
