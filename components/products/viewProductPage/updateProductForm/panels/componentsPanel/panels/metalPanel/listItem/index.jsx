...
export default function UpdateProductFormMetalListItem({ data }) {
  const addProductMetal = useUpdateProductFormStore(
    (state) => state.addProductMetal
  );
  const removeProductMetal = useUpdateProductFormStore(
    (state) => state.removeProductMetal
  );
  const productMetals = useUpdateProductFormStore(
