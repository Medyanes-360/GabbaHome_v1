...
export default function CreateProductFormMeasurementListItem({ data }) {
  const addProductMeasurement = useCreateProductFormStore(
    (state) => state.addProductMeasurement
  );
  const removeProductMeasurement = useCreateProductFormStore(
    (state) => state.removeProductMeasurement
  );
  const productMeasurements = useCreateProductFormStore(
