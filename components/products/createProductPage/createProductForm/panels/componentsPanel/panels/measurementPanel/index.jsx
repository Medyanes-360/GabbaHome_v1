...
import CreateProductFormMeasurementListItem from "./listItem";
...
export default function CreateProductFormComponentsPanelMeasurementPanel() {
            ...
            <tbody>
              {filteredData.length > 0 &&
                filteredData
                  ...
                  .map((measurement, index) => {
                    return (
                      <CreateProductFormMeasurementListItem
                        key={index}
                        data={measurement}
                      />
                    );
              ...
              {filteredData.length == 0 && (
                <tr className="text-3xl w-full  truncate text-center">
                  <td colSpan={9} className="w-full !py-5">
