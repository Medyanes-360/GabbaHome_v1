...
import CreateProductFormMetalListItem from "./listItem";
...
export default function CreateProductFormComponentsPanelMetalPanel() {
  const data = useMetalStore((state) => state.metals);
  const getAllMetals = useMetalStore((state) => state.getAllMetals);
            ...
            <tbody>
              {filteredData.length > 0 &&
                filteredData
                  ...
                  .map((metal, index) => {
                    return (
                      <CreateProductFormMetalListItem
                        key={index}
                        data={metal}
                      />
                    );
