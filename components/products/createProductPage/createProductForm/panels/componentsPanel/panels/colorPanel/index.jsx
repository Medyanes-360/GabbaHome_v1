...
import CreateProductFormColorListItem from "./listItem";
...
export default function CreateProductFormComponentsPanelColorPanel() {
  const data = useColorStore((state) => state.colors);
  const getAllColors = useColorStore((state) => state.getAllColors);

  const currentCurrency = useCreateProductFormStore(
            ...
            <tbody>
              {filteredData.length > 0 &&
                filteredData
                  ...
                  .map((color, index) => {
                    return (
                      <CreateProductFormColorListItem
                        key={index}
                        data={color}
                      />
                    );
