...
export default function CreateProductFormFabricListItem({ data }) {
  const addProductFabric = useCreateProductFormStore(
    (state) => state.addProductFabric
  );
  const removeProductFabric = useCreateProductFormStore(
    (state) => state.removeProductFabric
  );
  const productFabrics = useCreateProductFormStore(
