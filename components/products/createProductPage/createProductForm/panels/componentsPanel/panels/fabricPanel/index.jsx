...
import CreateProductFormFabricListItem from "./listItem";
...
export default function CreateProductFormComponentsPanelFabricPanel() {
            ...
            <tbody>
              {filteredData.length > 0 &&
                filteredData
                  ...
                  .map((fabric, index) => {
                    return (
                      <CreateProductFormFabricListItem
                        key={index}
                        data={fabric}
                      />
                    );
