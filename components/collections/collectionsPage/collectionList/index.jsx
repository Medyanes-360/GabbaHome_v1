...
export default function CollectionList() {
  const data = useCollectionStore((state) => state.collections);
  const getAllCollections = useCollectionStore(
    (state) => state.getAllCollections
  );
      ...
      <div className="pb-4 bg-white dark:bg-gray-900">
        ...
        <div className="relative mt-1">
          ...
          <input
            ...
            placeholder="Tüm Değerlerde Arayın"
          />
        </div>
      </div>
          ...
          <tbody>
            {filteredData
              ...
              .map((collection, index) => {
                return <CollectionListItem key={index} data={collection} />;
              })}
          </tbody>
        )}
      </table>
