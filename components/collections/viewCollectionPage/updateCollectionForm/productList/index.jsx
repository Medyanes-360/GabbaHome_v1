...
import UpdateCollectionFormProductListItem from "./productListItem";
import useGlobalStore from "@/zustand/globalStore";
import { filterData } from "@/functions/util/dataFilter";

export default function UpdateCollectionFormProductList({
  selectedProducts,
  setSelectedProducts,
}) {
        ...
        {!isLoading && (
          <tbody>
            {filteredData
              ...
              .map((product, index) => {
                return (
                  <UpdateCollectionFormProductListItem
