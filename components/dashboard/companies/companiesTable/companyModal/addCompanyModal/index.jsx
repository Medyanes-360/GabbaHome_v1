...
export default function AddCompanyModal({ isOpen, setIsOpen }) {
  ...
  const [bankAccountNumberInputValue, setBankAccountNumberInputValue] =
    useState("");
  const [bankMFOInputValue, setBankMFOInputValue] = useState("");
  const [ibanInputValue, setIbanInputValue] = useState("");
  const [kdvRatePercentInputValue, setKdvRatePercentInputValue] = useState(0);
