...
import MetalListItem from "./metalListItem";
...
export default function MetalListesi() {
            ...
            <tbody>
              {filteredData.length > 0 &&
                filteredData
                  ...
                  .map((metal, index) => {
                    return <MetalListItem key={index} data={metal} />;
                  })}
              {filteredData.length == 0 && (
                <tr className="text-3xl w-full  truncate text-center">
                  <td colSpan={6} className="w-full !py-5">
